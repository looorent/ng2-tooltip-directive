...
Install the npm package.
    ...
    npm i @looorent/ng2-tooltip-directive
        
Import `Ng2Module`:

```ts
import { TooltipModule } from '@looorent/ng2-tooltip-directive';
...
```ts
import { TooltipOptions } from '@looorent/ng2-tooltip-directive';
...
```ts
import { TooltipModule, TooltipOptions } from '@looorent/ng2-tooltip-directive';
